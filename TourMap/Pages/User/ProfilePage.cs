...
public class ProfilePage : ContentPage
{
    ...
    public ProfilePage(AuthService authService)
    {
        ...
        // Hide default nav bar to make the gradient header truly flush to the top
        ...
        {
            Spacing = 16, Margin = new Thickness(20, 0),
            Children =
            {
        ...
        // Empty state for now since logic is not wired
    ...
    private void OnLanguageChanged()
    {
        ...
        {
            // Title overrides shell text but we hid navbar anyway, useful for screen readers
            ...
            // Re-render role labels to apply correct localized string
            RefreshProfile();
        });
    }
